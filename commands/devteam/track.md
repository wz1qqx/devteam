...
argument-hint: "<list|status|context|bind|use> [track] [--root <path>] [--set <track>] [--feat <feat>] [--scope <name>] [--write] [--text] [--no-runtime] [--active-only] [--dry-run]"
allowed-tools:
  - Read
  - Write
  - Bash
