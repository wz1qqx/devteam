...
---
<objective>
Restore session state from .dev/features/<feature>/HANDOFF.json, STATE.md, and context.md.
</objective>
...
```bash
SKILL_FILE="${HOME}/.claude/plugins/marketplaces/devteam/skills/resume.md"
[ -f "$SKILL_FILE" ] || SKILL_FILE=$(ls ~/.claude/plugins/cache/devteam/devteam/*/skills/resume.md 2>/dev/null | head -1)
