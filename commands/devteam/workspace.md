...
argument-hint: "<scaffold|onboard|context> [--root <path>] [--set <track>] [--feat <feat>] [--name <name>] [--write] [--force] [--for codex|claude|human] [--text]"
allowed-tools:
  - Read
  - Write
  - Bash
...
---
<objective>
Create a devteam workspace layout and generate/read the agent onboarding protocol for any .devteam workspace.
</objective>
